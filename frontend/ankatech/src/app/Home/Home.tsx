    ...
    return(
        <section>
            ...
            <div className="lg:grid lg:grid-cols-2 sm:flex-col lg:px-16 justify-between">
                ...
                <div className="lg:w-120 sm:w-80 px-4 pt-5 lg:h-[30em] sm:h-max">
                    <h3 className="text-[#f7c41f] uppercase text-[1.5em]">Clientes</h3>
                    <ul className="flex flex-col w-full lg:h-[25em] sm:h-full overflow-auto border-l border-b px-4 rounded-bl-2xl border-black shadow-md gap-3">
