...
export default function SelectAtivosComponent(){
        ...
        <section className="flex flex-col py-19 items-center px-7">
            <div className="w-full h-108 flex flex-col justify-around gap-3 py-6 px-10 border border-[#5d5d5d] rounded-2xl">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <ul className="flex flex-col h-50 items-center w-full overflow-scroll gap-1">
                        {receiveAssets.length > 0 ? receiveAssets.map((dataclient, index)=>(
                                <li key={index} className="grid grid-cols-3 items-center w-full px-4 h-15 border border-[#5d5d5d] rounded-[.5rem]">
